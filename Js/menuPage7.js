...
let Bogdan = () => { window.location = 'Character/character55.html' }
let Domingo = () => { window.location = 'Character/character56.html' }
let Tuco = () => { window.location = 'Character/character57.html' }
let Marco = () => { window.location = 'Character/character58.html' }
let Lydia = () => { window.location = 'Character/character59.html' }
let Todd = () => { window.location = 'Character/character60.html' }
let Jane = () => { window.location = 'Character/character61.html' }
let Skinny = () => { window.location = 'Character/character62.html' }
let Brandon = () => { window.location = 'Character/character63.html' }
